...
struct LineToPointAdapter
{
    ...
    {
        int left = std::fmin(line.start.x, line.end.x);
        int right = std::fmin(line.start.x, line.end.x);
        int top = std::fmin(line.start.y, line.end.y);
        int bottom = std::fmax(line.start.y, line.end.y);
        int dx = right - left;
